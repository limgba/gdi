...
bool lmb::Intersect(const lmb::Rectangle& rect, const lmb::Circle& circle)
{
	int xl1 = rect.left;
	int yl1 = rect.top;
	int xr1 = rect.right;
...
bool lmb::Intersect(const lmb::Circle& circle, const lmb::Rectangle& rect)
{
	return lmb::Intersect(rect, circle);
}

bool lmb::Intersect(const lmb::Rectangle& rect1, const lmb::Rectangle& rect2)
{
	int xl1 = rect1.left;
	int yl1 = rect1.top;
	int xr1 = rect1.right;
...
bool lmb::Intersect(const lmb::Circle& circle1, const lmb::Circle& circle2)
{
